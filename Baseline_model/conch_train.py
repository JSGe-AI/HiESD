...
for d in range(1,6):
    ...
    train_dir = f"/data_nas2/gjs/ESD_2025/classification/CONCH_4class/5_fold/fold_{fold_num}/train"
    val_dir = f"/data_nas2/gjs/ESD_2025/classification/CONCH_4class/5_fold/fold_{fold_num}/val"
    ...
    for epoch in range(num_epochs):
        ...
        loop = tqdm(enumerate(train_loader), total=len(train_loader), leave=True)  # leave=True 
        ...
        with torch.no_grad():
            ...
            if overall_accuracy > best_accuracy:
                ...
                with open(f"/home/gjs/ESD_2025/Experiment/results/CONCH/4cls_conch_fold_{fold_num}.txt", "w") as f:
                    for label in target_labels:
                        label_str = str(label)
                ...
                torch.save(model.state_dict(), f"/home/gjs/ESD_2025/Experiment/ckpt/CONCH/4cls_best_fold_{fold_num}.pth") # Save model weights
